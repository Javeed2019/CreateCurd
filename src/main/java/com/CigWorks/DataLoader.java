...
public class DataLoader {
	...
	public DataLoader(PostDao postDao, AuthorDao authorDao) {
		super();
		PostDao = postDao;
		AuthorDao = authorDao;
	}
	...
	private void loadData()
	{
		...
		Author ah = new Author("Javeed","Shaik","shaik2570@gmail.com");
		AuthorDao.save(ah);
	...
	{
		Author jv= new Author("Sameer","Shaik","Sameer510@gmail.com");
		AuthorDao.save(jv);
		
		Author sj= new Author("Zunnu","Shaik","ZunnuRock@gmail.com");
		AuthorDao.save(sj);
		
		Author so = new Author("Sonu","Mohammad","SonuJaveed@gmial.com");
		AuthorDao.save(so);
	}
	...
	private void createPosts(Author author)
	{
		Date yesterday = null;
		 try {
			yesterday = new SimpleDateFormat("MM/dd/yyy h:mm:ss a").parse("12/18/1996 12:56:00 PM");
